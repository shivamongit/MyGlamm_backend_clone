...
async function showF() {
    try {
        ...
        console.log(res);
        console.log(res[0].skincare_id);
         data(res[0].skincare_id);
    } catch (err) {
        console.log(err);
    }
}
...
item.forEach(function (product) {
    ...
    img.addEventListener("click", function () {
        ...
        detail.push(obj);
        localStorage.setItem("Skincaredetail", JSON.stringify(detail));
        window.location.href = "skincareProduct.html";
    });
    ...
    div.append(imgDiv, name, des, rating, price, icon);
